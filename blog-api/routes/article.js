...
const { Test, GetArticle, GetArticles, CreateArticle, UpdateArticle, ToggleLike, CreateComment, DeleteComment, Search, GetNumber, DeleteArticle } = require('../controller/article')
...
router
    ...
    .delete('/article',  passport.authenticate('jwt', { session: false }), DeleteArticle)
